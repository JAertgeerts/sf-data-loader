...
if (!process.argv[2]) {
  console.log('');
  console.log('Deletes rows from the SF OBJECT from STDIN in CSV format.');
  console.log('');
  console.log('    Usage: delete.js OBJECT [ BULK_OPTIONS ] [ BATCH_OPTIONS ]');
  console.log('');
  console.log('Example:');
  console.log('');
  console.log('    sfexport "select Id from Contact" | sfdelete Contact');
  console.log('');
  process.exit(6);
}
